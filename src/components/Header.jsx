...
const Header = () => {
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }} className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <h2 style={{ fontSize: '25px', fontWeight: 'bold', width: '190px'}}>Старшов</h2>
        </a>
